...
Sou **Desenvolvedor Full-Stack**, apaixonado por tecnologia e pela criação de soluções completas — do front ao back.  
Construo aplicações modernas, intuitivas e bem estruturadas, sempre buscando unir **performance, clareza e boa experiência do usuário**.

Trabalho com foco em sistemas funcionais e escaláveis, explorando ideias criativas e evoluindo constantemente para entregar **valor real através do código**.

---

## 🚀 **O que eu faço**
- Desenvolvo interfaces responsivas e dinâmicas  
- Construo funcionalidades sólidas no back-end  
- Transformo conceitos em experiências digitais práticas  
- Estou sempre aprendendo novas tecnologias para elevar a qualidade dos meus projetos
